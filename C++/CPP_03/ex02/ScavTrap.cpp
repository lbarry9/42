...
/*   Updated: 2024/07/26 11:39:16 by marvin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// default constructor
ScavTrap::ScavTrap(void) // find out why can't iniatialise here- have to use this
{
	this->_name = "Noname";
...
ScavTrap::ScavTrap(std::string name)
{
	...
	std::cout << this->_hit_points << " " << this->_energy_points << " " << this->_attack_damage << " " << std::endl;
}
